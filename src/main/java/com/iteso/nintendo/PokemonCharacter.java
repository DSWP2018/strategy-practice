...
/*** Get pokemon name.* @return Name.*/
public final String getName() {
return name;
}
/*** Set pokemon name.* @param newName New name.*/
...
* @param attackedby PokemonType.
* @return Result of defense.
*/
public abstract String defend(int attackDamage, PokemonType attackedby);
...
*/
public final void setMainAttackDamage() {
this.mainAttackDamage = mainAttack.getDamage();
}
/**
...
this.secondAttackDamage = secondAttack.getDamage();
}
...
// }
/*** Get hit points. * @return hit points.*/
public final int getHitPoints() {
return hitPoints;
}
/** * Set new het points.* @param newHitPoints new hit points.*/
